...
TRACES: Dict[int, List[TraceItem]] = {
    ...
    10: [
        ...
        ("Dmit-NRT", ["nexttrace", "-M", "154.31.112.5"]),
        ("Eons-NRT", ["nexttrace", "-M", "103.168.154.1"]),
        ("HostHatch-NRT", ["nexttrace", "-M", "31.57.218.1"]),
        ...
        ("NeroCloud-NRT", ["nexttrace", "-M", "103.90.136.1"]),
        ("Sharon-NRT", ["nexttrace", "-M", "157.254.198.1"]),
        ("Softbank-NRT", ["nexttrace", "-M", "126.40.32.4"]),
        ...
        ("GCP-NRT", ["nexttrace", "-M", "34.146.177.1"]),
    ],
    11: [
